...
class ContentScoring extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final AssignmentPageController controller =
        Get.find<AssignmentPageController>();
    ...
    return Obx(() {
      ...
      if (controller.submissionsWithNullScore.isEmpty &&
          controller.submissionsWithScore.isEmpty) {
        return Center(
            child: Text(
      ...
      return SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Obx(() {
              if (controller.submissionsWithNullScore.isEmpty) {
                return Text('Tidak ada tugas yang diserahkan',
                    style: AppTextStyle.tsBodyRegular(AppColor.black));
              } else
                return Center(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final submission =
                          controller.submissionsWithNullScore[index];
            ...
            Obx(() {
              if (controller.submissionsWithScore.isEmpty) {
                return Text('Belum ada tugas yang dinilai',
                    style: AppTextStyle.tsBodyRegular(AppColor.black));
              } else
                return Container(
                  child: ListView.builder(
